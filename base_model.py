...
def create_model(show_summary: bool, n_features):
    ...
    model.add(keras.layers.Conv1D(filters=64, kernel_size=3, activation='relu', input_shape=(n_features, 1)))
...
def main():
    ...
    # split train eval and test to x, y
    ...
    model.fit(x=train_set_x, y=train_set_y, validation_data=(eval_set_x, eval_set_y), batch_size=128, epochs=20)
