...
def create_model(classes_number, split_counts):
    ...
    # DNN Categorical
    dense1 = tf.keras.layers.Dense(15, activation=tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l2(l=0.1))(concat0)
    #dp1 = tf.keras.layers.Dropout(0.15)(dense1)
    dense2 = tf.keras.layers.Dense(10, activation=tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l2(l=0.1))(dense1)
